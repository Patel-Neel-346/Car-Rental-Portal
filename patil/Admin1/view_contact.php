        ...
        <aside class="w-64 bg-gray-800 h-screen text-white p-5 fixed">
            ...
            <nav>
                <ul>
                    ...
                    <li class="mb-4"><a href="view_contact.php" class="block py-2 px-4 bg-gray-700  rounded hover:bg-gray-600">View User Contact</a></li>
                    ...
                    <tbody>
                        <?php while($row = $result->fetch_assoc()): ?>
                            <tr class="bg-gray-50 hover:bg-gray-100">
                                ...
                                <td class="border px-4 py-2"><?php echo $row['messg']; ?></td>
